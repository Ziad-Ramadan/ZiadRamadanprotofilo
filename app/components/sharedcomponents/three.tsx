...
import imgs from "../../Images/how-to-build-a-comprehensive-hospital-management.png"
export default function Projects() {
  const projects = [
    {
      title: "Hospital Management System",
      description:
        "Software solution that integrates various aspects of hospital operations, from patient management and appointment scheduling to billing and inventory control.",
      image: imgs,
      status: "In Progress",
    },
